					...
					<div class="col-lg-12 h-100">
						...
						<div class="row h-100">
							...
							<div class="col-lg-5 h-100 pale">
								...
								<div class="row h-15 ">
									<div class="row h-50 ml-15">
										<input class="rounded" style="color:black; border-color:dimgrey; width:20em; font-weight:bold; padding-left:1em" name="signup_username" placeholder="username">

									</div>
									<div class="row h-50 ml-15">
										<input class="rounded" style="color:black; border-color:dimgrey; width:20em; font-weight:bold; padding-left:1em" name="signup_email" placeholder="email">

									</div>
									<div class="row h-50 ml-15">
										<input type="password" class="rounded" style="color:black; border-color:dimgrey; width:20em; font-weight:bold; padding-left:1em" name="signup_password" placeholder="password">

									</div>
									<div class="row h-50 ml-15">
										<!--href="/Home/signup"-->
										<button id="signup-button" class="btn rounded" name="signup">
											<h5 style="margin-top:5px;">sign up</h5>
										</button>
									</div>
							...
							<div class="col-lg-7 h-100 ">
								<div class="row h-15">
									<div class="col-lg-2 ml-15" style="background-color:#bc8f2e;margin-top:-16%;height:15%;margin-left:1.10em; width:16.7%;"> </div>
								</div>
